...
export default function EmployeeOrdersPage() {
  ...
  const isPharmacyOrdersContext = ordersBasePath === "/pharmacy/orders";
  const canManageActivityOrders = isPharmacyAdmin && !isPharmacyOrdersContext;
  ...
  function handleStartEditActivityOrder(order: ActivityOrder) {
    if (!canManageActivityOrders) {
      setError("Orders activity is read-only for security.");
      return;
    }
